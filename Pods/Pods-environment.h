...
#define COCOAPODS_POD_AVAILABLE_JFOpenWeatherMapManager
#define COCOAPODS_VERSION_MAJOR_JFOpenWeatherMapManager 1
#define COCOAPODS_VERSION_MINOR_JFOpenWeatherMapManager 0
#define COCOAPODS_VERSION_PATCH_JFOpenWeatherMapManager 0
